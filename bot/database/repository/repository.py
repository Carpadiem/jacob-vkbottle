...
class Repository:
    ...
    def connect(self):
        try:
            ...
            self.cursor = self.connection.cursor(buffered=False, dictionary=True)
        except Exception as e: Log(f'[exception][repository.py / def connect]: {e}')
    ...
    def find_one_by(self, where: dict):
        ...
        try:
            ...
            self.close()
            return self.entity
        except Exception as e: Log(f'[exception][repository.py / def find_one_by]: {e}')
    ...
    def create(self, entity_like: dict) -> Entity:
        try:
            ...
            return new_entity
        except Exception as e: Log(f'[exception][repository.py / def create]: {e}')
    ...
    def save(self, entity: Entity):
        try:
            ...
            self.cursor.execute(query)
            self.close()
        except Exception as e: Log(f'[exception][repository.py / def save]: {e}')
    ...
    def update(self, where: dict, field: dict):
        try:
            ...
            self.cursor.execute(query)
            self.close()
        except Exception as e: Log(f'[exception][repository.py / def update]: {e}')
    ...
    def count(self):
        try:
            ...
            self.close()
            return len(row)
        except Exception as e: Log(f'[exception][repository.py / def count]: {e}')
    ...
    def close(self):
        ...
        except Exception as e: Log(f'[exception][repository.py / def close]: {e}')
